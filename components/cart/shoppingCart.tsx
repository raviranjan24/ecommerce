                                ...
                                <div className="list-cart">
                                    <div className="list-cart-item">
                                        <div className="image">
                                            <img
                                                className="lazyload"
                                                data-src="images/shop/popup-slidebar-item-1.jpg"
                                                src="images/shop/popup-slidebar-item-1.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="content">
                                            ...
                                            <div className="cart-item-bot">
                                                <div className="text-button price">$59.99</div>
                                                <a className="link text-button" href="#">
                                                    Add to cart
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="list-cart-item">
                                        <div className="image">
                                            <img
                                                className="lazyload"
                                                data-src="images/shop/popup-slidebar-item-2.jpg"
                                    ...
                                    <div className="list-cart-item">
                                        <div className="image">
                                            <img
                                                className="lazyload"
                                                data-src="images/shop/popup-slidebar-item-3.jpg"
                                                src="images/shop/popup-slidebar-item-3.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="content">
                                    ...
                                    <div className="list-cart-item">
                                        <div className="image">
                                            <img
                                                className="lazyload"
                                                data-src="images/shop/popup-slidebar-item-4.jpg"
                                                src="images/shop/popup-slidebar-item-4.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="content">
                                ...
                                <div className="tf-mini-cart-wrap">
                                            ...
                                            <div className="tf-mini-cart-items">
                                                <div className="tf-mini-cart-item file-delete">
                                                    <div className="tf-mini-cart-image">
                                                        <img
                                                            className="lazyload"
                                                            data-src="images/shop/popup-cart-item-1.jpg"
                                                            src="images/shop/popup-cart-item-1.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="tf-mini-cart-info flex-grow-1">
                                                        <div className="content">
                                                            <div className="left">
                                                                ...
                                                                <div className="text-secondary-2">Gray, Size C</div>
                                                ...
                                                <div className="tf-mini-cart-item file-delete">
                                                    <div className="tf-mini-cart-image">
                                                        <img
                                                            className="lazyload"
                                                            data-src="images/shop/popup-cart-item-2.jpg"
                                                            src="images/shop/popup-cart-item-2.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="tf-mini-cart-info flex-grow-1">
                                                ...
                                                <div className="tf-mini-cart-item file-delete">
                                                    <div className="tf-mini-cart-image">
                                                        <img
                                                            className="lazyload"
                                                            data-src="images/shop/popup-cart-item-3.jpg"
                                                            src="images/shop/popup-cart-item-3.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="tf-mini-cart-info flex-grow-1">
                                                ...
                                                <div className="tf-mini-cart-item file-delete">
                                                    <div className="tf-mini-cart-image">
                                                        <img
                                                            className="lazyload"
                                                            data-src="images/shop/popup-cart-item-4.jpg"
                                                            src="images/shop/popup-cart-item-4.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="tf-mini-cart-info flex-grow-1">
                                                ...
                                                <div className="tf-mini-cart-item file-delete">
                                                    <div className="tf-mini-cart-image">
                                                        <img
                                                            className="lazyload"
                                                            data-src="images/shop/popup-cart-item-5.jpg"
                                                            src="images/shop/popup-cart-item-5.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="tf-mini-cart-info flex-grow-1">
                                    ...
                                    <div className="tf-mini-cart-bottom">
                                        <div className="tf-mini-cart-tool">
                                            ...
                                            <div className="tf-mini-cart-tool-btn btn-add-coupon">
                                                <svg
                                                    width={21}
                                                    height={20}
                                                    viewBox="0 0 21 20"
                                        ...
                                        <div className="tf-mini-cart-bottom-wrap">
                                            ...
                                            <div className="text-center">
                                                <a className="link btn-line" href="shop-default.html">
                                        ...
                                        <div className="tf-mini-cart-tool-content">
                                            ...
                                            <form className="form-add-note tf-mini-cart-tool-wrap">
                                                ...
                                                <div className="tf-cart-tool-btns">
                                                    ...
                                                    <div className="text-center link w-full text-btn-uppercase tf-mini-cart-tool-close">
                                                        Cancel
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div className="tf-mini-cart-tool-openable estimate-shipping">
                                        <div className="tf-mini-cart-tool-content">
                                            <label className="tf-mini-cart-tool-text">
                                                ...
                                                <span className="text-title">Estimate shipping rates</span>
                                            </label>
                                            <form
                                            ...
                                            >
                                                ...
                                                <div className="tf-cart-tool-btns">
                                                    ...
                                                    <div className="text-center w-100 link tf-mini-cart-tool-close">
                                                        Cancel
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div className="tf-mini-cart-tool-openable add-coupon">
                                        <div className="tf-mini-cart-tool-content">
                                            <label className="tf-mini-cart-tool-text">
                                                <span className="icon">
                                                    <svg
                                            ...
                                            <form className="form-add-coupon tf-mini-cart-tool-wrap">
                                                <fieldset className="">
                                                    <div className="text-caption-1 text-secondary mb_8">
                                                        Enter Code
                                                    </div>
